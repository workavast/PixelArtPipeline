...
In editor tool to render 3D objects as spiteshits or single sprite with normal map — based on the character art pipeline of the [Dead Cells](https://dead-cells.com/)
